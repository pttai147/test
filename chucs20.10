...
<head>
    ...
    <!-- Thêm import font Great Vibes cho chữ ký -->
    ...
    <style>
        ...
        * {
        ...
        .textLetter h2 {
            font-size: 30px;
            font-weight: 700px;
            font-family: 'Dancing Script', cursive; /* Giữ nguyên như ban đầu */
        }
        ...
        .textLetter .contentLetter {
            ...
            font-family: 'Dancing Script', cursive; /* Giữ nguyên như ban đầu */
            position: initial;
            /* Ngắt dòng an toàn khi văn bản dài và cho phép cuộn nội dung */
        ...
        /* Tối ưu cho điện thoại: giới hạn chiều cao modal và cho cuộn nội dung */
        @media (max-width: 480px) {
            .boxLetter .formLetter {
                width: 92vw;
                height: auto;
                max-height: 80vh; /* Không vượt quá chiều cao màn hình */
            }
            .formLetter .wrapperLetter {
                overflow: hidden; /* Ẩn tràn tổng thể, chỉ cho phần nội dung cuộn */
            }
            .giftbox { display: none; } /* Ẩn ảnh hộp quà trong modal để dành chỗ cho chữ */
            .textLetter { padding: 6px 4px; }
            .textLetter h2 { font-size: 24px; }
            .textLetter .contentLetter {
                font-size: 16px;
                max-height: 58vh; /* Vùng cuộn nội dung */
                overflow-y: auto;
                -webkit-overflow-scrolling: touch;
                padding: 0 12px;
            }
            .heartAnimation { position: static; width: 120px; margin: 8px auto 0; }
            .signature { right: 12px; bottom: 8px; font-size: 16px; }
        }
    </style>
</head>
...
<body>
        ...
        <div class="boxLetter">
            ...
            <div class="formLetter">
                ...
                <div class="wrapperLetter">
                    ...
                    <!-- Thêm chữ ký ở đây -->
                    <div class="signature"><br>gửi em</div>
                </div>
            </div>
    ...
    <script>
        ...
        const textLetterH2 = "Hello cô gái :)";
        ...
        const textLetterP = `Chúc em ngày 20/10 thật ngọt ngào như nụ cười của em vậy 💐. Mong em luôn xinh đẹp, rạng rỡ và hạnh phúc mỗi ngày. Với anh, chỉ cần nhìn thấy em cười là mọi mệt mỏi tan biến. Cảm ơn em vì đã xuất hiện và khiến trái tim anh lỡ nhịp mỗi lần nhìn thấy. 🌷💖`;
